...
We don't expect you to be a great UI designer. However, your dashboard page should be tidy and clean enough to watch. Some considerations to help you create a tidy page including:
  ...
  + 
  + 
  + Page should be filled thoroughly with content without leaving any blank spaces in a full-width length of a page.
...
Some considerations to help you create a tidy plot including:
  ...
  + Numeric axis text should be formatted such that every 3 digit is separated by comma (20,000 instead of 20000)
  + No redundant information. For example, if category is already presented as y axis you don't need to fill/color the data based on the category
  ...
  + No overlapping axis text, long text should not be rotated with 90% degree rotation. Some [tips](https://datavizpyr.com/how-to-dodge-overlapping-text-on-x-axis-labels-in-ggplot2/)
